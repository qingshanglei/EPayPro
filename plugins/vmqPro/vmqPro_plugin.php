...
{
	static public $info = [
		'name'        => 'vmqPro', //支付插件英文名称，需和目录名称一致，不能有重复
		'showname'    => 'vmqPro', //支付插件显示名称
		'author'      => '青衫', //支付插件作者
		'link'        => 'https://github.com/qingshanglei/vmqPro', //支付插件作者链接
	...
	static public function submit(){
		...
		$param = '';
		$price = sprintf("%.2f", $order['realmoney']);
		$data = array(
			"payId" => TRADE_NO,
			"type" => $paytype,
			"price" => $price,
	...
	static public function notify(){
		...
		$param = isset($_GET['param'])?$_GET['param']:'';//自定义透传参数
