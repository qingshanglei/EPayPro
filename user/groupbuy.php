	...
	<div class="panel panel-default">
        ...
        <form class="form-horizontal devform">
			...
			<input type="hidden" name="group_price" value="">
				...
				<div class="form-group" id="num_form" style="display:none;">
					<label class="col-sm-3 control-label">购买份数</label>
					<div class="col-sm-8">
						<div class="input-group">
							<span class="input-group-btn"><input id="num_min" type="button" class="btn btn-info" style="border-radius: 0px;" value="━"></span>
							<input id="num" name="num" class="form-control" type="number" min="1" value="1" readonly=""/>
	...
	$.ajax({
		...
		success: function (data, textStatus) {
			...
			if (data.code == 0) {
				...
				if(data.expire==0)$("#num_form").hide();
				else $("#num_form").show();
				$("#listFrame").slideUp();
				$("#infoFrame").slideDown();
			}else{
